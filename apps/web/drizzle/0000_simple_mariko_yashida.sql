...
CREATE TABLE "agents" (
	...
	"links" jsonb,
	"erc8004_active" boolean DEFAULT true,
	"x402_support" boolean DEFAULT true,
	"agent_wallet" text,
	"services" jsonb DEFAULT '[]'::jsonb,
	"registrations" jsonb DEFAULT '[]'::jsonb,
	"supported_trust" text[] DEFAULT '{"reputation"}',
...
CREATE INDEX "agents_wallet_idx" ON "agents" USING btree ("agent_wallet");--> statement-breakpoint
