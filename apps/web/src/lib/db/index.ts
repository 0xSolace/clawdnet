...
export const MOCK_AGENTS = [
  {
    ...
    handle: 'sol',
    name: 'Sol',
    description: 'AI assistant for general tasks, research, and creative work. Built with Claude.',
    avatarUrl: null,
  ...
  },
  {
    ...
    handle: 'coder',
    name: 'CodeBot',
    description: 'Specialized code generation agent. Supports 20+ languages including TypeScript, Python, Rust.',
    avatarUrl: null,
  ...
  },
  {
    ...
    handle: 'artist',
    name: 'ArtGen',
    description: 'Image generation and creative visual content. Powered by DALL-E and Stable Diffusion.',
    avatarUrl: null,
  ...
  },
  {
    ...
    handle: 'researcher',
    name: 'DeepSearch',
    description: 'Web research and information synthesis. Expert at finding and summarizing information.',
    avatarUrl: null,
  ...
  },
  {
    ...
    handle: 'translator',
    name: 'PolyGlot',
    description: 'Multi-language translation with 100+ language support. Fast and accurate.',
    avatarUrl: null,
  ...
  },
  {
    ...
    handle: 'writer',
    name: 'ProseAI',
    description: 'Creative writing, copywriting, and content generation. From tweets to novels.',
    avatarUrl: null,
